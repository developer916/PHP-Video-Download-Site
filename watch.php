        ...
        <div class="row text-center margin-bottom-60">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-sm-offset-3">
                <div class="form-group margin-bottom-25">
                    ...
                    <input type="text" class="form-control" name="url" id="url" placeholder="Paste URL or search here" value="http://www.youtube.com/watch?v=<?php echo $_GET['v']?>">
                </div>
                <div class="form-group">
                    <a class="btn-u btn-u-red buttons"  href="javascript:void(0)" onclick="processSearchString()" id="go-button">Go</a>
                    <a href ="javascript:void(0)" class="btn-u btn-u-orange download-video" style="display: none" id="download-video">Download Video</a>
                    <a href ="javascript:void(0)" class="btn-u btn-u-orange download-mp3" style="display: none" id="download-mp3" onclick="downloadMp3()">Download Mp3</a>
                    <a href ="javascript:void(0)" class="btn-u btn-u-orange download-vimeo" style="display: none" id="download">Download</a>
                </div>
