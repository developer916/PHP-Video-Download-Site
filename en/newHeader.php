                ...
                <div class="social-info-wrap">
                    <div class="social-info">
                        <div class="social-info-front social-facebook">
                            <?php if($pageNo == 1) {?>
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(HOST_SERVER.'/');?>" onclick="javascript:window.open(this.href,
                ...
                <div class="social-info-wrap">
                    <div class="social-info">
                        <div class="social-info-front social-twitter">
                            <?php if($pageNo == 1) {?>
                            <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(HOST_SERVER);?>/&text=<?php echo urlencode('Wouptube rocks! Download from YouTube, Vimeo, DailyMotion and many more!')?>" onclick="javascript:window.open(this.href,
                                     '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;">
                                <?php }?>
                ...
                <div class="social-info-wrap">
                    <div class="social-info">
                        <div class="social-info-front social-google">
                            <?php if($pageNo == 1) {?>
                            <a href="https://plus.google.com/share?url=<?php echo urlencode(HOST_SERVER);?>/" onclick="javascript:window.open(this.href,
                      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;">
                                <?php }?>
...
<nav id="cd-lateral-nav" >
    <ul class="cd-navigation cd-single-item-wrapper header-navigation">
        <li><a <?php if($pageNo == 1) {?> class="current" <?php } ?> href="./"><?php echo $language_home;?></a></li>
        <li><a <?php if($pageNo == 2) {?> class="current" <?php } ?>  href="./about"><?php echo $language_about;?></a></li>
        <li><a <?php if($pageNo == 3) {?> class="current" <?php } ?>  href="./how-to-download-youtube-videos-using-wouptube"><?php echo $language_help;?></a></li>
        <li><a href="#"><?php echo $language_trick;?></a></li>
        <li><a <?php if($pageNo == 5) {?> class="current" <?php } ?> href="./contact"><?php echo $language_contact_us;?></a></li>
    </ul>
</nav>
<main class="cd-main-content" <?php if($pageNo == 1){?> id="index-main" <?php } else if($pageNo == 2){ ?> id="about-main" <?php }?>>
    <div class="wrapper" <?php if($pageNo == 2) {?>  id="about-us-wrapper" <?php }else if($pageNo == 5){?> id="contact-us-wrapper" <?php } ?>>
        <?php if($pageNo == 1) {?>
            <div class="interactive-slider-v2">
                <div class="container" id="homeText">
                    <h1 class ="fadeInUp"><?php echo $language_welcome_to_wouptube;?></h1>
                    <p class ="fadeInUp"><a href="index.php" style="color: white; text-decoration: none;"><?php echo $language_youtube_downloader_youtube_to_mp3_converter;?></a></p>
                    <p class ="fadeInUp">(<?php echo $language_also_works_with_vimeo_dailymotion;?>)</p>
                </div>
                <div class="container content" id="homeStar">
