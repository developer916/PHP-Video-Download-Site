...
?>
    <div class="flat-bg-block-v1 parallaxBg1" id="contactBody">
        <div class="container">
            <div class="row">
			...
			<div class="alert alert-success" id="success" style="display:none">
                <?php echo $language_contact_message_successfully;?>
			</div>
                    <form action="contactFormSend.php" method="post" id="sky-form3" class="sky-form contact-style">
                        <fieldset class="no-padding">
                            <label> <?php echo $language_name; ?> <span class="color-red">*</span></label>
                            ...
                            <label><?php echo $language_email;?> <span class="color-red">*</span></label>
                            <div class="row sky-space-20">
                                <div class="col-md-7 col-md-offset-0">
                                    <div>
                            ...
                            <label><?php echo $language_message;?> <span class="color-red">*</span></label>
                            <div class="row sky-space-20">
                            ...
                            <p>
					<button type="button" class="btn-u btn-u-red" onclick="onContactSend()"><?php echo $language_send_message;?></button>
					<div id="spin" style="display:none"></div>	
				</p>
                        </fieldset>
                        <div class="message">
                            <i class="rounded-x fa fa-check"></i>
                            <p><?php echo $language_message_was_successfully_sent;?></p>
                        </div>
                    </form>
                </div>
            </div>
...
<?php require_once('../common/newFooter.php');?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            var reallyMainHeight = $("#contactBody").outerHeight();
            if(reallyMainHeight < mainHeight){
                $('#contactBody').attr('style', 'min-height:' + mainHeight+'px');
            }
        });
